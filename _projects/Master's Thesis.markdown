...
[comment]: <> (title: Personalized Search with Deep Learning)

[comment]: <> (description: This project was my Master's thesis for Masters in Artificial Intelligence &#40;2017-2018&#41;. )

[comment]: <> (The final text can be downloaded from <a href="{{ site.url }}/download/Master_Thesis/Thesis.pdf">here</a>.)
